...
### 1. Hook (15 sec)
**Show landing page**
> "Businesses have $3 trillion locked in unpaid invoices. What if you could earn real DeFi yield on that money while you wait to get paid? That's Faktory."
...
### 6. Close (15 sec)
> "Faktory: real yield on real invoices, across 4 chains. Built with Aave V3, Pyth oracles, and an autonomous AI agent."
